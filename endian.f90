...
contains
	...
	integer(kind=int32) function swap32(input) result(num)
		...
		byte1 = ishft(iand(input, z'000000ff'), 24)
		byte2 = ishft(iand(input, z'0000ff00'), 8)
		byte3 = ishft(iand(input, z'00ff0000'), -8)
		byte4 = ishft(iand(input, z'ff000000'), -24)
	...
	integer(kind=int16) function swap16(input) result(num)
		...
		integer :: byte1, byte2
		byte1 = ishft(iand(input, z'00ff'), 8)
		byte2 = ishft(iand(input, z'ff00'), -8)
		num = ior(byte1, byte2)
	end function swap16
